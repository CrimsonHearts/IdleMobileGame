...
`smoke5.js` through `smoke15.js` in the repo root (numbered by the feature
...
```bash
for t in smoke5 smoke6 smoke7 smoke8 smoke9 smoke10 smoke11 smoke12 smoke13 smoke14 smoke15; do
