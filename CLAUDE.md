...
`smoke5.js` through `smoke28.js` in the repo root (numbered by the feature
...
```bash
for t in smoke5 smoke6 smoke7 smoke8 smoke9 smoke10 smoke11 smoke12 smoke13 smoke14 smoke15 smoke16 smoke17 smoke18 smoke19 smoke20 smoke21 smoke22 smoke23 smoke24 smoke25 smoke26 smoke27 smoke28; do
